...
import { userSignup } from '../../Api/authentication';
    ...
    <div className="w-screen h-[screen] grid grid-cols-2 bg-hero2 bg-cover bg-center">
      ...
      <div className="w-screen sm:w-6/12 h-fit sm:h-screen flex justify-center items-center">
        <Toaster
          ...
          reverseOrder={false}
        />
        <form onSubmit={handleSubmit(handleRegistration)} className="w-full max-w-sm min-w-[300px] p-6 h-fit max-h-fit bg-[#5408e1a9] rounded-lg shadow-lg shadow-[#b908e1fb]">
          ...
          <div className="w-full mt-2 flex justify-center gap-2">
            ...
            />
            {(phone.length >= 10 && !verified) && <button type="button" className="bg-[#0800ff] text-white w-20 h-10 rounded-lg p-2 " onClick={handleVerification}>Confirm</button>}
          </div>
